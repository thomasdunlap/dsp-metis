...
* P(i/t) = P(t/i) * P(i) / P(t)
* P(i/t) = 1 * 1/300 / (1/125 + 1/300)
* **P(identical/twin) = .294**
---

### Q6. Bayesian &amp; Frequentist Comparison  
How do frequentist and Bayesian statistics compare?

Frequentist statistics make inferences based on the aggregate information of a sample, where as Bayesian statistics use a more iterative situational approach.
---
