...
I prefer vim because I've seen other developers using it, and it has many more commands that take time to learn, but ultimately make things more efficient.
